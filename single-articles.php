...
<?php $postlink = (empty(get_field('external_read_more_link')) ? get_permalink() : get_field('external_read_more_link'))?>
		<section class="section">
			<div class="container">
				<a style="margin-top: 90px;margin-right: 21px;display: flex;align-items: center;" href="/founderstory"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
