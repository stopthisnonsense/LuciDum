...
<?php $postlink = (empty(get_field('external_read_more_link')) ? get_permalink() : get_field('external_read_more_link'))?>
		<section class="section section-title">
			<div class="container">
				<a style="margin-top: 90px;margin-right: 21px;display: flex;align-items: center;" href="/blogs"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M20 8.75H4.7875L11.775 1.7625L10 0L0 10L10 20L11.7625 18.2375L4.7875 11.25H20V8.75Z" fill="#45969B"/>
</svg> &nbsp &nbsp  Back to Blog
</a>
			</div>
		</section>
